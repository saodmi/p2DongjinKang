...
<img src="https://user-images.githubusercontent.com/55647419/115169730-d1acdd80-a0f9-11eb-8bc9-48f161b18c95.jpg" width="100%">

The dashboard improved five previously illustrated dashboards to create a new control interface. Once the entire dashboard consists of LCD displays. When viewing information on a dashboard, the driver's eye should be immediately drawn to the most important area, even if it is not necessarily located in the most visually prominent area on the screen. The tachometer and speedometer are on both sides and above are the indicators associated with the turn signal lamp, and other important warning and indicators are placed under the arrangement. The current gear is displayed in the middle of the tachometer and the speed in the middle of the speedometer is expressed numerically. In addition, the engine temperature and fuel condition were shown below each other, not only on a bar graph, but also on a scale, making it easier to distinguish. Time and seat belt indicators were placed based on the number 13, and the cruise indicator on the left and the temperature outside on the right were numerically displayed. Adding more than this variety of images and useless decorations make the display confusing and much more difficult to interpret the meaning of the data. Consistency in the means of display whenever appropriate saves time and energy by allowing the driver to use the same perceptual strategy to interpret the data. Beyond choosing the right way to present information and messages, we sought the design of components that communicate clearly and efficiently without distracting the driver. In addition, if the color is not emphasized too much or matched with the surroundings, it becomes an obstacle to the driver's visual concentration and sense. Therefore, the overall color was shown in white with letters and numbers on a black background, and important warning lights and indicators were red or orange.
